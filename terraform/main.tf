...
resource "yandex_compute_instance" "vm" {
  ...
  metadata = {
    ssh-keys = "ubuntu:${file("/home/barvv/workout/devops-for-programmers-project-77/terraform/ssh/id_rsa.pub")}"
  }
...
EOT
  ...
  connection {
    type        = "ssh"
    user        = "ubuntu"
    private_key = file("/home/barvv/workout/devops-for-programmers-project-77/terraform/ssh/id_rsa")
